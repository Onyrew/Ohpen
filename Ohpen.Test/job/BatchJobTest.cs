...
namespace Ohpen.Test.job
{
    internal class BatchJobTest
    {
        ...
        public void Setup()
        {
            ...
            // Job
            job = new BatchJob(processor.Object, items, logger.Object);
        }
        ...
        [Test]
        public async Task RunDoesNotRunForAllItems()
        {
            // Arrange
            items.Clear();
            for (int i = 0; i < 100; i++)
            ...
            // Assert
            Assert.That(job.Status.ProcessedCount, Is.LessThan(99)); // 99 can pass
        }
    }
}
